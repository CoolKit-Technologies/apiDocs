(function () {
    ...
    /**
     * Renders main content # 修改的地方
     * @param {Object} config Configuration object
     * @returns {String} HTML of the main content
     */
    function main(config) {
        var name = (config.name && (typeof config.name === 'string')) ? escapeString(config.name):'';
        var aside =
    ...
    function cover() {
        ...
        return (
            "<section class=\"cover show\" style=\"" + bgc + "\">" +
            '<div class="cover-main"><!--cover--></div>' +
            '<div class="mask"></div>' +
            '</section>'
        );
    ...
    ********************************************** */
    ...
    function renderName(vm) {
        ...
        if (isPrimitive(vm.config.name)) {
          ...
          var match = Object.keys(name).filter(function (key) { return path.indexOf(key) > -1; })[0];
