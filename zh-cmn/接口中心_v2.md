...
| Authorization   | 不允许为空   | API调用凭证，计算方法见[开发文档/签名规则](/#/zh-cmn/开发文档?id=签名规则)   | 
...
| **名称**   | **类型**   | **允许为空**   | **说明**   | 
|:----|:----|:----|:----|
| itemType   | Int   | N   | item的类型  1=用户自己的设备  2=别人分享的设备  3=自己的群组  4=别人分享的群组（保留）   | 
