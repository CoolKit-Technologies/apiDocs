 ...
 * @LastEditors: Carl
 * @LastEditTime: 2020-07-27 15:24:32
--> 
...
| 刷新认证token| post /v2/user/sms-login     | “acesss token”缺省30天失效（安全原因），此时可以不用重新登录获取“acesss token”，而是使用“refresh token”刷新获取“acesss token” |
| 设置额外推送渠道| post /v2/user/extra-push     | 支持设置谷歌推送渠道 |
| 退出登录| delete /v2/user/logout     | 退出登录 |
| 注销账号| /v2/user/close-account     | 注销账号 |
